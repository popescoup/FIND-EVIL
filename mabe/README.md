...
- **Velocity** — AI agents operate at machine speed. Human operators work at human speed (minutes to hours). The velocity differential is empirically estimated at 47–158x.
- **Traversal pattern** — AI agents enumerate exhaustively. Human operators move purposefully (targeted, fewer hops).
...
# Run full simulation (200 benign + 5 attack sessions)
python main.py
...
| `--sessions-benign` | `200` | Number of benign sessions |
| `--sessions-attack` | `5` | Number of attack sessions |
...
|---|---|
| Anthropic GTG-1002 (Nov 2025) | Sub-second velocity, exhaustive enumeration, credential harvesting |
| SANS/Lee (Dec 2025) | 47–158x velocity multiplier, human baseline timing |
| Dragos water utility (May 2026) | Scope expansion |
