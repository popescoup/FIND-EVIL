...
class AIAttackerAgent:
    ...
    seed : int
        Integer seed passed to VelocityModel for its numpy RNG. Provided
        separately from rng so that simulate.py can derive it
        deterministically (e.g. base_seed + session_index) without
        consuming values from the shared rng stream.
    """
